...
Crafty.c("Particles", {
    ...
    particles: function (options) {
        ...
        this.bind('EnterFrame', function () {
            relativeX = this.x + this._w/2 + Crafty.viewport.x;
            relativeY = this.y + this._h/2 + Crafty.viewport.y;
...
* @param easing: (Craftyf object) - The object that handles the internal progress of the animation.
